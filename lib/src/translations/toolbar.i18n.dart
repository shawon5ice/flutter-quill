  ...
  static final _t = Translations.byLocale('en') +
      {
        ...
        'bn': {
          ...
          'Ok': 'ঠিক আছে',
          'Select Color': 'কালার নির্বাচন করুন',
          'Gallery': 'গ্যালারি',
          'Link': 'লিঙ্ক', 
          'Please first select some text to transform into a link.':
              'লিঙ্কে রূপান্তর করতে অনুগ্রহ করে প্রথম কয়েকটি টেক্সট নির্বাচন করুন৷',
          'Open': 'ওপেন',
          'Copy': 'কপি',
          'Remove': 'রিমুভ',
          'Save': 'সেভ,
          ...
          'Saved': 'সেভ করা হয়েছে',
          'Text': 'টেক্সট',
          'What is entered is not a link': 'এটি কোন লিঙ্ক নয়',
          'Resize': 'রিসাইজ', 
          'Width': 'প্রস্থ',
          'Height': 'উচ্চতা',
          'Size': 'আকার',
